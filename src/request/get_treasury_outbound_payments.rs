...
/**You should use this struct via [`StripeClient::get_treasury_outbound_payments`].

On request success, this will return a [`GetTreasuryOutboundPaymentsResponse`].*/
...
for FluentRequest<'a, GetTreasuryOutboundPaymentsRequest> {
    type Output = httpclient::InMemoryResult<GetTreasuryOutboundPaymentsResponse>;
