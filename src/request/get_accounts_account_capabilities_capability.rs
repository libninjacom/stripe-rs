...
/**You should use this struct via [`StripeClient::get_accounts_account_capabilities_capability`].

On request success, this will return a [`Capability`].*/
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct GetAccountsAccountCapabilitiesCapabilityRequest {
    pub account: String,
    pub capability: String,
    pub expand: Option<Vec<String>>,
}
impl GetAccountsAccountCapabilitiesCapabilityRequest {}
...
for FluentRequest<'a, GetAccountsAccountCapabilitiesCapabilityRequest> {
