...
/**You should use this struct via [`StripeClient::get_issuing_disputes`].

On request success, this will return a [`GetIssuingDisputesResponse`].*/
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct GetIssuingDisputesRequest {
...
impl GetIssuingDisputesRequest {}
...
impl<'a> ::std::future::IntoFuture for FluentRequest<'a, GetIssuingDisputesRequest> {
    type Output = httpclient::InMemoryResult<GetIssuingDisputesResponse>;
