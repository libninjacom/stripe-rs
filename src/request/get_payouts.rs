...
/**You should use this struct via [`StripeClient::get_payouts`].

On request success, this will return a [`GetPayoutsResponse`].*/
...
impl<'a> ::std::future::IntoFuture for FluentRequest<'a, GetPayoutsRequest> {
    type Output = httpclient::InMemoryResult<GetPayoutsResponse>;
