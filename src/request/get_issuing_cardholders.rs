...
/**You should use this struct via [`StripeClient::get_issuing_cardholders`].

On request success, this will return a [`GetIssuingCardholdersResponse`].*/
...
impl<'a> ::std::future::IntoFuture for FluentRequest<'a, GetIssuingCardholdersRequest> {
    type Output = httpclient::InMemoryResult<GetIssuingCardholdersResponse>;
