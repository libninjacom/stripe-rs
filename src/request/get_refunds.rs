...
/**You should use this struct via [`StripeClient::get_refunds`].

On request success, this will return a [`GetRefundsResponse`].*/
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct GetRefundsRequest {
...
impl<'a> ::std::future::IntoFuture for FluentRequest<'a, GetRefundsRequest> {
    type Output = httpclient::InMemoryResult<GetRefundsResponse>;
