...
/**You should use this struct via [`StripeClient::get_identity_verification_sessions_session`].

On request success, this will return a [`IdentityVerificationSession`].*/
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct GetIdentityVerificationSessionsSessionRequest {
    pub expand: Option<Vec<String>>,
    pub session: String,
}
impl GetIdentityVerificationSessionsSessionRequest {}
...
for FluentRequest<'a, GetIdentityVerificationSessionsSessionRequest> {
