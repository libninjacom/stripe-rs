...
/**You should use this struct via [`StripeClient::get_transfers`].

On request success, this will return a [`GetTransfersResponse`].*/
...
impl<'a> ::std::future::IntoFuture for FluentRequest<'a, GetTransfersRequest> {
    type Output = httpclient::InMemoryResult<GetTransfersResponse>;
