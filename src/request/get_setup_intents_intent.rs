...
/**You should use this struct via [`StripeClient::get_setup_intents_intent`].

On request success, this will return a [`SetupIntent`].*/
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct GetSetupIntentsIntentRequest {
    pub client_secret: Option<String>,
    pub expand: Option<Vec<String>>,
    pub intent: String,
}
impl GetSetupIntentsIntentRequest {}
...
impl<'a> ::std::future::IntoFuture for FluentRequest<'a, GetSetupIntentsIntentRequest> {
