...
/**You should use this struct via [`StripeClient::get_quotes`].

On request success, this will return a [`GetQuotesResponse`].*/
...
impl<'a> ::std::future::IntoFuture for FluentRequest<'a, GetQuotesRequest> {
    type Output = httpclient::InMemoryResult<GetQuotesResponse>;
