...
#[derive(Clone)]
pub struct GetPaymentMethodConfigurationsConfigurationRequest<'a> {
    pub(crate) http_client: &'a StripeClient,
    pub configuration: String,
    pub expand: Option<Vec<String>>,
}
impl<'a> GetPaymentMethodConfigurationsConfigurationRequest<'a> {
...
for GetPaymentMethodConfigurationsConfigurationRequest<'a> {
