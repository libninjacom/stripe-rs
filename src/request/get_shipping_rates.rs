...
/**You should use this struct via [`StripeClient::get_shipping_rates`].

On request success, this will return a [`GetShippingRatesResponse`].*/
...
impl<'a> ::std::future::IntoFuture for FluentRequest<'a, GetShippingRatesRequest> {
    type Output = httpclient::InMemoryResult<GetShippingRatesResponse>;
