...
/**You should use this struct via [`StripeClient::get_disputes`].

On request success, this will return a [`GetDisputesResponse`].*/
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct GetDisputesRequest {
...
impl<'a> ::std::future::IntoFuture for FluentRequest<'a, GetDisputesRequest> {
    type Output = httpclient::InMemoryResult<GetDisputesResponse>;
