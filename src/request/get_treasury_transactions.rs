...
/**You should use this struct via [`StripeClient::get_treasury_transactions`].

On request success, this will return a [`GetTreasuryTransactionsResponse`].*/
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct GetTreasuryTransactionsRequest {
...
impl GetTreasuryTransactionsRequest {}
impl FluentRequest<'_, GetTreasuryTransactionsRequest> {
    ...
    pub fn status_transitions(
        ...
        self.params.status_transitions = Some(status_transitions);
        self
    }
}
impl<'a> ::std::future::IntoFuture
for FluentRequest<'a, GetTreasuryTransactionsRequest> {
    type Output = httpclient::InMemoryResult<GetTreasuryTransactionsResponse>;
    type IntoFuture = ::futures::future::BoxFuture<'a, Self::Output>;
    fn into_future(self) -> Self::IntoFuture {
        Box::pin(async move {
            let url = "/v1/treasury/transactions";
