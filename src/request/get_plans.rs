...
/**You should use this struct via [`StripeClient::get_plans`].

On request success, this will return a [`GetPlansResponse`].*/
...
impl<'a> ::std::future::IntoFuture for FluentRequest<'a, GetPlansRequest> {
    type Output = httpclient::InMemoryResult<GetPlansResponse>;
