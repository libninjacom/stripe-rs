...
/**You should use this struct via [`StripeClient::get_webhook_endpoints_webhook_endpoint`].

On request success, this will return a [`WebhookEndpoint`].*/
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct GetWebhookEndpointsWebhookEndpointRequest {
    pub expand: Option<Vec<String>>,
    pub webhook_endpoint: String,
}
impl GetWebhookEndpointsWebhookEndpointRequest {}
...
for FluentRequest<'a, GetWebhookEndpointsWebhookEndpointRequest> {
