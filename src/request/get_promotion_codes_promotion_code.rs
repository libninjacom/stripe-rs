...
/**You should use this struct via [`StripeClient::get_promotion_codes_promotion_code`].

On request success, this will return a [`PromotionCode`].*/
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct GetPromotionCodesPromotionCodeRequest {
    pub expand: Option<Vec<String>>,
    pub promotion_code: String,
}
impl GetPromotionCodesPromotionCodeRequest {}
...
for FluentRequest<'a, GetPromotionCodesPromotionCodeRequest> {
