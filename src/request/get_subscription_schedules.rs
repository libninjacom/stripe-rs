...
/**You should use this struct via [`StripeClient::get_subscription_schedules`].

On request success, this will return a [`GetSubscriptionSchedulesResponse`].*/
...
for FluentRequest<'a, GetSubscriptionSchedulesRequest> {
    type Output = httpclient::InMemoryResult<GetSubscriptionSchedulesResponse>;
