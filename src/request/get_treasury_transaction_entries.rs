...
/**You should use this struct via [`StripeClient::get_treasury_transaction_entries`].

On request success, this will return a [`GetTreasuryTransactionEntriesResponse`].*/
...
for FluentRequest<'a, GetTreasuryTransactionEntriesRequest> {
    type Output = httpclient::InMemoryResult<GetTreasuryTransactionEntriesResponse>;
