...
/**You should use this struct via [`StripeClient::post_subscriptions_subscription_exposed_id`].
...
impl PostSubscriptionsSubscriptionExposedIdRequest {}
impl FluentRequest<'_, PostSubscriptionsSubscriptionExposedIdRequest> {}
impl<'a> ::std::future::IntoFuture
for FluentRequest<'a, PostSubscriptionsSubscriptionExposedIdRequest> {
