...
/**You should use this struct via [`StripeClient::get_terminal_readers_reader`].

On request success, this will return a [`serde_json::Value`].*/
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct GetTerminalReadersReaderRequest {
    pub expand: Option<Vec<String>>,
    pub reader: String,
}
impl GetTerminalReadersReaderRequest {}
...
for FluentRequest<'a, GetTerminalReadersReaderRequest> {
