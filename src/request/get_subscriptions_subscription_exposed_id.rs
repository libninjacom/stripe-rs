...
/**You should use this struct via [`StripeClient::get_subscriptions_subscription_exposed_id`].

On request success, this will return a [`Subscription`].*/
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct GetSubscriptionsSubscriptionExposedIdRequest {
    pub expand: Option<Vec<String>>,
    pub subscription_exposed_id: String,
}
impl GetSubscriptionsSubscriptionExposedIdRequest {}
...
for FluentRequest<'a, GetSubscriptionsSubscriptionExposedIdRequest> {
