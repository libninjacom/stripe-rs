...
/**You should use this struct via [`StripeClient::get_accounts_account_external_accounts_id`].

On request success, this will return a [`ExternalAccount`].*/
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct GetAccountsAccountExternalAccountsIdRequest {
    pub account: String,
    pub expand: Option<Vec<String>>,
    pub id: String,
}
impl GetAccountsAccountExternalAccountsIdRequest {}
...
for FluentRequest<'a, GetAccountsAccountExternalAccountsIdRequest> {
